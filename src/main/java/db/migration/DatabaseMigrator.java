...
import com.indiareads.service.boot.PersistenceContext;
...
public class DatabaseMigrator {
	private static final String LIQUIBASE_ENABLED = "liquibase.enabled";
	private static final String LIQUIBASE_ENABLED_VALUE = "true";
	private static final String LIQUIBASE_CHANGE_LOG_VALUE = "classpath:/db/changelog/db.changelog-master.xml";
	private static final String MIGRATION_BANNER_LOCATION_VALUE = "migrator.txt";
	...
	private static final String MIGRATION_BANNER_LOCATION = "banner.location";
	private static final String MIGRATION_SERVER_PORT = "server.port";

	public static void main(String[] args) {
		System.setProperty(LIQUIBASE_ENABLED, LIQUIBASE_ENABLED_VALUE);
		System.setProperty(MIGRATION_SERVER_PORT, MIGRATION_SERVER_PORT_VALUE);
		System.setProperty(MIGRATION_BANNER_LOCATION, MIGRATION_BANNER_LOCATION_VALUE);
